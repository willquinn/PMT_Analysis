...
def main():
    ...
    plt.plot(x_ch0_1, apulse_data_Ch0[4], '.', color='r', label='low cut')
    plt.plot(x_ch0_1, apulse_data_Ch0[6], '.', color='g', label='medium cut')
    plt.plot(x_ch0_1, apulse_data_Ch0[8], '.', color='b', label='high cut')
