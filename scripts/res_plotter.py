...
def main():
    ...
    data_file_Ch0_name = args.i + "1000_resolution_vs_date_Ch0.txt"
    data_file_Ch1_name = args.i + "1000_resolution_vs_date_Ch1.txt"
    ...
    data_Ch0 = np.loadtxt(data_file_Ch0_name, delimiter=',', dtype={'names': ('unix', 'date', 'timestamp', 'mu', 'mu_err', 'sigma', 'sigma_err', 'res', 'chi_err'),
    ...
    x_ch0 = process_exposure(data_Ch0[1])
